...
/*Iterable - означает что все обьекты этого класса можно перебирать (итерировать). Содержит всего один метод, который
// возвращает итератор (тот самый  обьект-закалдку, который позволяет перебирать коллекцию)
